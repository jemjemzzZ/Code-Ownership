...
# p1.1 proportion influence on dataset correlation performance
def proportion_validate(vulnerable_df, non_vulnerable_df):
    ...
    print(similarity_scores) # Min-Max Scaling
    print(f"Min-Max Scaling Avg Score: {sum(similarity_scores)/len(similarity_scores)}")
    print(similarity_scores_exp) # Exponential Decay
    print(f"Exponential Decay Avg Score: {sum(similarity_scores_exp)/len(similarity_scores_exp)}")
...
# p1.2 threshold of minor influence on AGE/IS_DEFECTIVE correlation performance
...
# p1.3 group component influence on dataset correlation performance
